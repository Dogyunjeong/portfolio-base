...
export interface DynamicComponentProps
  extends CustomComponentTypes.CustomComponentProps {}
...
const DynamicComponent: React.FC<DynamicComponentProps> = (props: any) => {
  ...
  switch (props.componentData.uuid) {
    case "portfolio-collection":
      return <Portfolio.Collections {...props} />;
    case "link-svg":
      return <SvgLink {...props} />;
    case "link":
    ...
    case "deprecate-tati-home":
      return <TatiHome {...props} />;
    case "deprecate-tati-info":
      return <TatiInfo {...props} />;
    case "deprecate-tati-shop":
      return <TatiShop {...props} />;
    case "deprecate-tati-achive":
      return <TatiArchive {...props} />;
    default:
      return <Loading />;
  }
};
